...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'stolitsa_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  stolitsa.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Задати запитання на тендер
  ...
  stolitsa.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Додати предмет закупівлі
  ...
  stolitsa.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  stolitsa.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Підтвердити підписання контракту
  ...
  Sleep  5
  stolitsa.Завантажити угоду до тендера  ${username}  ${tender_uaid}  1  ${filepath}
  Wait Until Page Contains Element  xpath=(//*[@id='tPosition_status' and not(contains(@style,'display: none'))])
